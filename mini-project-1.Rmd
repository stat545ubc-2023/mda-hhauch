...
*I choose the cancer_sample dataset. My reasoning for doing this is because I am
currently doing my degree in biological sciences so it is relevant to my field. 
Additional this is a breat cancer data set and my mom was diagnosed with breast 
cancer in 2021. It was thankfully caught early and she is in remission. I understand
the importance of data science within medicine and research so I think it would 
be interesting if my first (mini) data analysis was within that area.*
...
<!-------------------------- Start your work below ---------------------------->
*Is there a relationship between variables of breast cancer cell nuclei and 
...
This exercise is relevant as it allows us to visualize the data. For this milestone I chose to look 
look at radius_mean so I used that variable for this exercise. I also added color by diagnosis to get 
some separation in the data and begin to see the relationship between radius_mean and diagnosis. We can 
also see the count is much higher for lower radius's and for benign diagnoses. 
...
I choose this exercise as it allows to to tackle my first research question, investigating 
if there is a relationship between mean radius of breast cancer cell nuclei and the patients diagnosis.
In this exercise I can compare one of the variables measured with the diagnosis of the patient to see
if there is a relationship. Through just this plot we are able to see that the cells from metastatic (M) breast cancer have on average a higher mean nuclei radius. 
...
After establishing if there is a relationship between some of the variables and the diagnosis of the 
patient I think I will want to look further into the patients diagnosed with metastatic cancer so I 
filtered the data to only show data from patients with metastatic cancer. 
...
This is relevant to this data as there there is large range in each variable. I decided to apply the box plot to the plot I made for exercise 4 to better understand the distribution of the data for both diagnosis.  
