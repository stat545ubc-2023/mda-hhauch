...
Additionally, this is a breast cancer data set and my mom was diagnosed with breast 
...
This exercise is relevant as it allows us to visualize the data. For this milestone I chose to 
look at radius_mean as I used that variable for this milestone. I also added color by diagnosis to get 
...
I choose this exercise as it allows to to tackle my first research question by investigating 
...
This is relevant to this data as there is large range in each variable. I decided to apply the box plot to the plot I made for exercise 4 to better understand the distribution of the data for both diagnosis.  
